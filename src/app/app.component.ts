...
export class AppComponent {
  ...
  public coches:Array<Coche>=[	new Coche('renault','scenic',new Date(2007,10,1),new Date(2018,3,1),5000,'',EstadoCoche.BUENO),
							new Coche('seat','ibiza',new Date(2003,4,12),new Date(2018,2,1),1200,'',EstadoCoche.BUENO),
							new Coche('renault','megane',new Date(2006,12,23),new Date(2018,2,1),3500,'',EstadoCoche.MALO),
  ...
  public getFiltrados():Array<number>{
	  ...
	  {
		  if (coche.modelo.lastIndexOf(this.filtro, 0) === 0) filtrados.push(indice);
		  indice=indice+1;
	  }
	return filtrados;
  }
